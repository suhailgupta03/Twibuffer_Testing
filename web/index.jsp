<%-- 
    Document   : index
    Created on : Apr 13, 2014, 7:07:40 PM
    Author     : user
--%>

<%@page import="org.suhail.thread.Twfinder"%>
    ...
    <body>
        <% 
            if(request.getAttribute("isregistered") != null) {
                if((Boolean)request.getAttribute("isregistered")) {
        %>
                    <script type="text/javascript">alert("Registered Successfully"); </script>
        <%
                    request.removeAttribute("isregistered");
                }
            }
        %>
        
		<div class="wrapper">
			<center> <h1>Twibuffer</h1> </center>
			<center> <h2><span>Twitter Scheduler</span></h2> </center>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
						...
						<div class="bottom">
							...
							<div class="clear"></div>
                                    ...
                                    <form class="login active" method="post" action="login">
						<h3>Login</h3>
						<div>
							<label>Username:</label>
							<input type="text" name="username" />
						...
						<div class="bottom">
							...
							<div class="clear"></div>
                                    ...
                                    <form class="forgot_password" method="post" action="#">
